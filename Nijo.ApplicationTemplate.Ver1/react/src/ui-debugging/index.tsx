...
export const getDebuggingPages = (): { groupName: string, links: (ReactRouter.RouteObject & { label: string })[] }[] => [
  ...
  {
    groupName: 'QueryModelのデバッグ',
    links: AutoGenerated.getQueryModelTypeList().map(queryModelType => ({
      path: `/query-model/${queryModelType}`,
      label: queryModelType,
      element: <QueryModelLoadView queryModel={queryModelType} />,
    })),
  }
]
