...
import ResponsiveFormTest_02_中継コンポーネント from "./ResponsiveFormTest_02_中継コンポーネント"
import ResponsiveFormTest_03_条件分岐とループ from "./ResponsiveFormTest_03_条件分岐とループ"
...
export const getDebuggingPages = (): { groupName: string, links: (ReactRouter.RouteObject & { label: string })[] }[] => [
  {
    ...
    links: [
      ...
      },
      {
        ...
        label: '中継コンポーネントのテスト',
        element: <ResponsiveFormTest_02_中継コンポーネント />,
      },
      {
        path: '/responsive-form/003',
        label: '条件分岐とループ処理のテスト',
        element: <ResponsiveFormTest_03_条件分岐とループ />,
      },
    ],
  },
  {
