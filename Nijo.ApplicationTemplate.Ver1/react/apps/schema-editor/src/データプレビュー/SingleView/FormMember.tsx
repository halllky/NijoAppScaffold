...
export const AggregateMemberFormView = ({ record, onChangeRecord, member, nextMember, owner, ownerName, ownerIsReadOnly }: {
  ...
  member: MetadataOfEFCoreEntity.AggregateMember | MetadataOfEFCoreEntity.Aggregate
  /** memberの1つ次 */
  nextMember: MetadataOfEFCoreEntity.AggregateMember | MetadataOfEFCoreEntity.Aggregate | undefined
  owner: MetadataOfEFCoreEntity.Aggregate
  ownerName: string
