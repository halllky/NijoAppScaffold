- [NijoAppScaffold - スキーマ駆動型アプリケーション生成フレームワーク](#nijoappscaffold---スキーマ駆動型アプリケーション生成フレームワーク)
  - [このフレームワークの構成要素](#このフレームワークの構成要素)
    - [ソースコード自動生成処理](#ソースコード自動生成処理)
    - [アプリケーションのテンプレート](#アプリケーションのテンプレート)
  - [開発手順概要](#開発手順概要)
    - [0. 初期設定](#0-初期設定)
...
# NijoAppScaffold - スキーマ駆動型アプリケーション生成フレームワーク
NijoAppScaffoldは、XMLベースのスキーマ定義からアプリケーションコードの一部を自動生成するフレームワークです。
...
- React.js, Windows Forms など任意のUIフレームワークでクライアント側を構築したい
...
ここで作成されるのは、NijoAppScaffoldが提供する標準のスキーマ定義と標準のアプリケーションテンプレートです。
