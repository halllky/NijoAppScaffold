...
SELECT
    ...
    T3.STORE_NAME AS 診療科_STORE_NAME,
    T3.PHONE AS 診療科_PHONE,
    SA.POSTAL_CODE AS 診療科_住所_POSTAL_CODE,
    SA.PREFECTURE AS 診療科_住所_PREFECTURE,
    SA.CITY AS 診療科_住所_CITY,
    SA.ADDRESS_LINE AS 診療科_住所_ADDRESS_LINE,
    BH.OPENING_TIME AS 診療科_診療時間_OPENING_TIME,
    BH.CLOSING_TIME AS 診療科_診療時間_CLOSING_TIME,
    E.ID AS 診療科_MANAGER_ID_ID,
    E.NAME AS 診療科_MANAGER_ID_NAME,
    E.NAME_KANA AS 診療科_MANAGER_ID_NAME_KANA,
    E.TAISHOKU AS 診療科_MANAGER_ID_TAISHOKU,
