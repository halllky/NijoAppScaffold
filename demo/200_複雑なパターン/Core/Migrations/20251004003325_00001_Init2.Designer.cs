...
namespace Demo200.Migrations
{
    ...
    [Migration("20251004003325_00001_Init2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApp.時間帯別収益SearchResult", b =>
                {
                    b.Property<int>("診療収益分析_年月")
                        .HasColumnType("INTEGER");

                    b.Property<string>("診療収益分析_診療科_診療科ID")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("診療収益分析_年月", "診療収益分析_診療科_診療科ID", "時間帯");
            ...
            modelBuilder.Entity("MyApp.機器分類別収益SearchResult", b =>
                {
                    ...
                    b.HasKey("診療収益分析_年月", "診療収益分析_診療科_診療科ID", "機器分類_機器分類ID");
            ...
            modelBuilder.Entity("MyApp.機器別収益SearchResult", b =>
                {
                    b.Property<int>("機器分類別収益_診療収益分析_年月")
                        .HasColumnType("INTEGER");

                    b.Property<string>("機器分類別収益_診療収益分析_診療科_診療科ID")
                        .HasColumnType("TEXT");

                    b.Property<string>("機器分類別収益_機器分類_機器分類ID")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("機器分類別収益_診療収益分析_年月", "機器分類別収益_診療収益分析_診療科_診療科ID", "機器分類別収益_機器分類_機器分類ID", "医療機器_機器ID");
            ...
            modelBuilder.Entity("MyApp.時間帯別収益SearchResult", b =>
                {
                    b.HasOne("MyApp.診療収益分析SearchResult", "診療収益分析")
                        .WithMany("時間帯別収益")
                        .HasForeignKey("診療収益分析_年月", "診療収益分析_診療科_診療科ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyApp.機器別収益SearchResult", b =>
                {
                    b.HasOne("MyApp.機器分類別収益SearchResult", "機器分類別収益")
                        .WithMany("機器別収益")
                        .HasForeignKey("機器分類別収益_診療収益分析_年月", "機器分類別収益_診療収益分析_診療科_診療科ID", "機器分類別収益_機器分類_機器分類ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
