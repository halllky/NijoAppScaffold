...
*学習指向 - NijoAppScaffoldを段階的に学ぶ*

チュートリアルは、NijoAppScaffoldの使い方を段階的に学ぶためのガイドです。実際に手を動かしながら、基本的な概念から応用まで習得できます。

## 初心者向け

### [5分で作る住所録アプリ](./getting-started.md)
NijoAppScaffoldを初めて使う方向けの最初のチュートリアルです。簡単な住所録アプリを作成しながら、基本的な流れを理解できます。
