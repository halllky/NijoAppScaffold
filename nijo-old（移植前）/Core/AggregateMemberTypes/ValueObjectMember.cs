...
namespace Nijo.Core.AggregateMemberTypes {
    ...
    internal class ValueObjectMember : StringMemberType {
        public ValueObjectMember(string className, string primitiveType) {
        ...
        protected override E_SearchBehavior GetSearchBehavior(AggregateMember.ValueMember vm) => vm.Options.SearchBehavior ?? E_SearchBehavior.PartialMatch;
