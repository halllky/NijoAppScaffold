    ...
    public sealed class MemberTypeResolver {
        public static MemberTypeResolver Default() {
            var resolver = new MemberTypeResolver()
                ...
                .Register(TYPE_SEARCH_CONDITION_ONLY_BOOL, new SearchConditionOnlyBoolean())
                ...
                .Register(TYPE_SEQUENCEMEMBER, new SequenceMember());
            return resolver;
        }
        ...
        internal const string TYPE_SEARCH_CONDITION_ONLY_BOOL = "search-condition-only-bool";
        ...
        internal const string TYPE_SEQUENCEMEMBER = "seq";
