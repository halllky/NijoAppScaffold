...
namespace Nijo.Core {
    ...
    public sealed class AggregateBuildOption {
        ...
        /// </summary>
        public bool? DisableLocalRepository { get; set; } = true;
        ...
        ///// <summary>
        ///// グリッドのref-toを参照している項目のUIをコンボボックスにする
        ///// </summary>
        //public bool? IsGridCombo { get; init; }
        ...
        public bool ForceGenerateRefToModules { get; set; }

        /// <summary>
        /// BatchUpdateReadModelsのActionをカスタマイズするかどうか
        /// </summary>
        public bool CustomizeBatchUpdateReadModels { get; set; }
    }
    ...
    public sealed class AggregateMemberBuildOption {
        ...
        /// <summary>実数値、整数、シーケンスの全体桁数</summary>
        public int? TotalDigits { get; set; }
        /// <summary>実数値の少数部桁数</summary>
        ...
        /// <summary>gridのref-to項目のUIをコンボボックスにする</summary>
        public bool? IsGridCombo { get; set; }

        /// <summary>nijo.xmlで定義したシーケンス名</summary>
    ...
    internal static class DirectedEdgeExtensions {
        ...
        internal const string REL_ATTR_IS_GRID_COMBO = "is-grid-combo";
        ...
        /// <summary>
        /// ref-toのグリッドでのUIをコンボボックスにするかどうか
        /// </summary>
        internal static bool UseComboBoxAsGrid(this GraphEdge graphEdge) {
            return graphEdge.Attributes.TryGetValue(REL_ATTR_IS_GRID_COMBO, out var value)
                && (bool?)value == true;
        }
    }
