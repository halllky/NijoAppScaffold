...
namespace Nijo.Models.WriteModel2Features {
    ...
    internal class DataClassForRefTargetKeys {
        ...
        internal IEnumerable<KeyMember> GetValueMembers() {
            return _aggregate
                .GetKeys(AggregateMember.E_GetMembersFlag.ValueMember)
        ...
        internal IEnumerable<DescendantRefTargetKeys> GetRelationMembers() {
            return _aggregate
                .GetKeys(flags: AggregateMember.E_GetMembersFlag.Ref | AggregateMember.E_GetMembersFlag.Parent | AggregateMember.E_GetMembersFlag.Child)
