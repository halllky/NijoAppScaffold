...
namespace Nijo.CodeGenerating {
    ...
    public class GeneratedProjectOptions {
        ...
        public string CoreLibraryFolderName => _xDocument.Root?.Attribute(nameof(CoreLibraryFolderName))?.Value ?? "core.AutoGenerated";

        /// <summary>WebAPIプロジェクトフォルダ名</summary>
        [Description("【省略可能】WebAPIプロジェクトフォルダ名。未指定の場合は\"webapi\"")]
        public string WebapiProjectFolderName => _xDocument.Root?.Attribute(nameof(WebapiProjectFolderName))?.Value ?? "webapi";

        /// <summary>Reactプロジェクトフォルダ名</summary>
        [Description("【省略可能】Reactプロジェクトフォルダ名。未指定の場合は\"react/src\"")]
        public string ReactProjectFolderName => _xDocument.Root?.Attribute(nameof(ReactProjectFolderName))?.Value ?? "react/src";

        /// <summary>単体テストプロジェクトフォルダ名</summary>
        [Description("【省略可能】単体テストプロジェクトフォルダ名。未指定の場合は\"Test\"")]
        public string UnitTestProjectFolderName => _xDocument.Root?.Attribute(nameof(UnitTestProjectFolderName))?.Value ?? "Test";
