        ...
        private string RenderWebapi(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public partial class {{controller.CsClassName}} : {{AspNetController.CONTROLLER_BASE}} {
                    public {{controller.CsClassName}}({{ApplicationService.ABSTRACT_CLASS}} applicationService, {{AspNetController.CONTROLLER_HANDLER_INTERFACE}} autoGeneratedControllerHandler) {
                        _applicationService = applicationService;
                        {{AspNetController.CONTROLLER_HANDLER_FIELD}} = autoGeneratedControllerHandler;
                    }
                    /// <summary>アプリケーションサービス</summary>
                    private readonly {{ApplicationService.ABSTRACT_CLASS}} _applicationService;
                    /// <summary>HTTPリクエスト/レスポンスと実際の処理の間を取り持つハンドラー。処理詳細は手動実装されている。</summary>
                    private readonly {{AspNetController.CONTROLLER_HANDLER_INTERFACE}} {{AspNetController.CONTROLLER_HANDLER_FIELD}};
