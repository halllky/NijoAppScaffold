...
- [StructureModel](./StructureModel.md) : 単純な構造体を表します。C#クラスとTypeScript型を生成し、サーバー/クライアント間で共有します。
- [ConstantModel](./ConstantModel.md) : 定数モデルを表します。C#とJavaScript/TypeScriptで常に値が同期される定数のソースコードが生成されます。
