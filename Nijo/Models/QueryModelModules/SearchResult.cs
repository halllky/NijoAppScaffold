...
namespace Nijo.Models.QueryModelModules {
    ...
    internal class SearchResult : IInstancePropertyOwnerMetadata, IEFCoreEntity {
        ...
        public string DbSetName => MapToEFCoreEntity
            ? $"{Aggregate.PhysicalName}SearchResultDbSet"
        ...
        public string OnModelCreatingAutoGenerated => MapToEFCoreEntity
            ? $"AutoGeneratedFluentApi{Aggregate.PhysicalName}SearchResult"
        ...
        internal class SearchResultValueMember : ISearchResultMember, IInstanceValuePropertyMetadata {
            ...
            private class SearchResultColumn : EFCoreEntity.EFCoreEntityColumn {
                ...
                internal override string DbName => _valueMember.GetPropertyName(E_CsTs.CSharp);
                internal override bool IsKey => false;
            }
        }
