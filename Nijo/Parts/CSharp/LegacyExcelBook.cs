        ...
        internal static void Render(CodeRenderingContext ctx) {
            ...
            var contents = $$"""
                            ...
                            public partial class ExcelBook {
                                ...
                                /// このブックにシートを追加します。
                                /// </summary>
                                public virtual DataSheet<T> AddSheet<T>(string sheetName) {
                            ...
                            /// <summary>
                            /// <see cref="ExcelBook"/> の内部で使用される、
                            /// Excelのシート1枚と対応するクラス。
                            /// </summary>
                            public partial class DataSheet<TItem> {
                                ...
                                /// <summary>
                                /// <cref="RenderRows"/> したときにレンダリングされる列を定義する。
                                /// </summary>
                                public DataSheet<TItem> AddColumn<TProp>(Func<TItem, TProp> propertySelector, IEnumerable<string> columnHeaders, int decimalPlace = 0) {
                                ...
                                /// <summary>
                                /// <cref="AddColumn"/> で追加された列定義をもとに、引数のデータをExcelシートにレンダリングする。
                                /// </summary>
                                public void RenderRows(IEnumerable<TItem> items) {
                                    // フォント
