        ...
        internal static SourceFile RenderPresentationContextModelBinder(CodeRenderingContext ctx) {
            return new SourceFile {
                ...
                Contents = $$"""
                    ...
                    /// PresentationContext のモデルバインディング
                    /// </summary>
                    public sealed class {{PRESENTATION_CONTEXT_BINDER}}<TMessageRoot> : IModelBinder where TMessageRoot : {{MessageContainer.SETTER_INTERFACE}} {
        ...
        internal static void RegisterWebapiConfiguration(IMultiAggregateSourceFileManager ctx) {
            ctx.Use<ApplicationConfigure>()
                ...
                .AddWebapiMethod($$"""
                    ...
                    /// <param name="bindingContext">ASP.NET Core が提供するモデルバインディングの仕組みが提供する情報。</param>
                    /// <param name="metadata">NijoApplicationBuilderが提供するメタ情報</param>
                    public abstract Task<{{PresentationContext.INTERFACE}}<TMessageRoot>> {{INITIALIZE_PRESENTATION_CONTEXT}}<TMessageRoot>(ModelBindingContext bindingContext, {{AUTOGENERATED_ACTION_METADATA}} metadata) where TMessageRoot : {{MessageContainer.SETTER_INTERFACE}};
                    """)
                .AddWebapiMethod($$"""
                    /// <summary>
