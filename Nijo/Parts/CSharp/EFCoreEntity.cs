...
namespace Nijo.Parts.CSharp {
    ...
    internal class EFCoreEntity : IInstancePropertyOwnerMetadata, IEFCoreEntity {
        ...
        public string OnModelCreatingAutoGenerated => $"AutoGeneratedFluentApi{Aggregate.PhysicalName}";
        internal const string ON_MODEL_CREATING_CUSTOMIZE = "OnModelCreating";
        ...
        internal static string RenderClassDeclaring(EFCoreEntity rootEfCoreEntity, CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                """)}}
                {{tree.SelectTextTemplate(efCoreEntity => $$"""
                    {{WithIndent(EFCoreOnModelCreating.RenderConfigureAbstractMethod(efCoreEntity), "    ")}}
                """)}}
                }
