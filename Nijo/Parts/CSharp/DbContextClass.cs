            ...
            return new SourceFile {
                ...
                Contents = $$"""
                    ...
                    """)}}
                        ...
                        /// <summary>
                        /// 外部キー参照の依存関係の順番でDbSetを列挙します。
                        /// 開発用データセット作成や、レガシーシステムからのデータ移行など、
                        /// スキーマ全体でデータを投入するテーブルの順番が重要である処理に活用できます。
                        /// </summary>
                        public virtual IReadOnlyList<IEntityType> GetDbSetsInDependencyOrder() {
                            return [
                    {{efCoreEntitiesOrderByDataFlow.SelectTextTemplate(entity => $$"""
                                {{entity.DbSetName}}.EntityType,
                    """)}}
                            ];
                        }
