    ...
    internal class LegacyDbContextClass : IMultiAggregateSourceFile {
        ...
        void IMultiAggregateSourceFile.Render(CodeRenderingContext ctx) {
            ...
            var dbSetLines = efCoreEntitiesOrderByDataFlow
                ...
                .ToArray();
            var dbSets = dbSetLines.Length == 0
                ? string.Empty
                : dbSetLines[0] + string.Concat(dbSetLines.Skip(1).Select(line => $"{System.Environment.NewLine}        {line}"));
            var onModelCreatingLines = efCoreEntitiesOrderByDataFlow
                ...
                .ToArray();
            var onModelCreatingCalls = onModelCreatingLines.Length == 0
                ? string.Empty
                : $"        {onModelCreatingLines[0]}" + string.Concat(onModelCreatingLines.Skip(1).Select(line => $"{System.Environment.NewLine}                {line}"));
