...
namespace Nijo.Parts.JavaScript {
    ...
    internal static class LegacyCompatibilityJavaScript {
        internal static void RenderReact(CodeRenderingContext ctx) {
            ...
            ctx.ReactProject(dir => {
                ...
                dir.Directory("util", utilDir => {
                    utilDir.Generate(RenderTypeScriptUtilIndex(hasReadModel2, hasCommandModel));
        ...
        private static SourceFile RenderTypeScriptUtilIndex(bool hasReadModel2, bool hasCommandModel) {
            return new SourceFile {
                FileName = "index.ts",
                Contents = $$"""
                    export * from "./MSG"
