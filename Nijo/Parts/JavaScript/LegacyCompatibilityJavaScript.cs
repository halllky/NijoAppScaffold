    ...
    internal static class LegacyCompatibilityJavaScript {
        internal static void RenderReact(CodeRenderingContext ctx) {
            ...
            ctx.ReactProject(dir => {
                ...
                dir.Directory("util", utilDir => {
                    utilDir.Generate(RenderTypeScriptUtilIndex(hasReadModel2, hasCommandModel, hasWriteModel2));
        ...
        private static SourceFile RenderAutoGeneratedMenu(CodeRenderingContext ctx) {
            ...
            .Where(root => root.Model is Models.ReadModel2
              || root.Model is Models.QueryModel
              || (root.Model is Models.WriteModel2 && root.GenerateDefaultQueryModel))
              .SelectMany(root => {
...
""",
        ...
        private static SourceFile RenderTypeScriptUtilIndex(bool hasReadModel2, bool hasCommandModel, bool hasWriteModel2) {
            ...
            if (hasReadModel2) {
                exports.Add(@"export * from ""./constraints""");
            }
            if (hasReadModel2 || hasWriteModel2) {
                exports.Add(@"export * from ""./single-view-util""");
            }
            if (hasReadModel2 || hasCommandModel) {
                exports.Add(@"export * from ""./auth-util""");
            }

            return new SourceFile {
                FileName = "index.ts",
                Contents = $$"""
                    {{exports.OrderBy(e => e, StringComparer.OrdinalIgnoreCase).SelectTextTemplate(e => $$"""
                    {{e}}
                    """)}}
                    """,
            };
